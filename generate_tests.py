...
def main():
    ...
    test_size = [10, 100, 1000, 10000, 100000, 500000, 1000000, 1000000, 1000000]
    # Parent Directory path
    parent_dir = "/Users/priya/IdeaProjects/PythonCodes/src"
    ...
    for i in range(1, 10):
        ...
        for p_s in pattern_size:  # fixing pattern size
            ...
            for s in alpha_size:  # fixing set of chars
                ...
                for m in range(test):
                    q1 = random.randint(1, len(2*p))
                    q2 = random.randint(1, len(2*p))
