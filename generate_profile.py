...
for pattern in pattern_size:
    ...
    test_output_dir_naive = "/Users/gaganganapathyas/Spring 22 - SBU/CSE 549 - BIO/Project/outputs/naive_" + str(pattern)
    test_output_dir_suffix_tree = "/Users/gaganganapathyas/Spring 22 - SBU/CSE 549 - BIO/Project/outputs/suffix_tree_" + str(pattern)
